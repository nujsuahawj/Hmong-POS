...
return array(
    ...
    */
    ...
    //home page
    "welcome_to_gp" => "ຍິນດີເຂົ້າສູ່ hmong pos",
    ...
    "yes" => "Yes",
    "no" => "No",
    "enable_user" => "ເປີດໃຊ້ງານ ຜູ້ໃຊ້",
    "disable_user" => "ປິດໃຊ້ງານ ຜູ້ໃຊ້",

    // Warning
    "are_you_sure" => "ແ່ນໃຈລະບໍ່?",
    "service_deleted_permanently" => "ບໍລິການນີ້ຈະຖືກລຶບຢ່າງຖາວອນ.",
    "branch_deleted_permanently" => "ສາຂານີ້ຈະຖືກລຶບຢ່າງຖາວອນ.",
    "sales_channel_deleted_permanently" => "ຊ່ອງທາງການຂາຍນີ້ຈະຖືກລຶບອອກຖາວອນ.",
    "payment_deleted_permanently" => "ຮູບແບບການຈ່າຍເງິນນີ້ຈະຖືກລຶບອອກຖາວອນ.",
    ...
    "hi_there" => "ສະ​ບາຍ​ດີ!",
    "sign_in_to_your_dashboard" => "ເຂົ້າສູ່ລະບົບ dashboard ຂອງທ່ານ.",
    "sign_up_for_your_new_account" => "Sign up for your new account.",

    'failed' => 'ຂໍ້ມູນບໍ່ຖືກ.',
    'throttle' => 'ກະລຸນາລ່ອງໃໝ່.',

    'password' => 'ລະຫັດຜ່ານບໍ່ຖືກ.',
    ...
    // Login Controller
    "inactive_invalid_email" => "ອີເມວທີ່ເລືອກບໍ່ຖືກຕ້ອງ ຫຼືທ່ານຕ້ອງການຢືນຢັນທີ່ຢູ່ອີເມວຂອງທ່ານ.",
    "email_or_password_is_wrong" => "ອີເມວ ແລະລະຫັດຜ່ານບໍ່ກົງກັນ.",
    ...
    "something_wrong" => "ອຸຍ, ມີບາງຢ່າງຜິດພາດເກີດຂຶ້ນ!!!",
    ...
    "logout" => "ທ່ານໄດ້ອອກຈາກລະບົບສຳເລັດແລ້ວ.",
    ...
    "error_update" => "ເກີດຄວາມຜິດພາດໃນລະຫວ່າງການອັບເດດ",
    "update_successful" => "ອັບເດດສຳເລັດແລ້ວ.",
    "delete_fail" => "ລຶບບໍ່ສຳເລັດ.",
    "delete" => "ລຶບສຳເລັດແລ້ວ.",
    "getting_problems" => "ໂອ້, ມີບາງຢ່າງຜິດພາດ!",

    // Profile Information
    "profile_title" => "ໂປຣໄຟລ໌ຂອງຂ້ອຍ",
    "date_of_birth" => "ວັນ​ເດືອນ​ປີ​ເກີດ",
    "gender" => "ເພດ",
    "male" => "ຊາຍ",
    "female" => "ຍິງ",
    "others" => "ອື່ນໆ",
    "change_profile_image" => "ປ່ຽນຮູບໂປຣໄຟລ໌",
    "image_only" => "ເລືອກຮູບພາບເທົ່ານັ້ນ",
    "profile_update_success" => "ອັບເດດໂປຣໄຟລ໌ສຳເລັດແລ້ວ.",
    "profile" => "ໂປຣໄຟລ໌",
    ...
    "password_change_success" => "ປ່ຽນລະຫັດຜ່ານສຳເລັດແລ້ວ.",
    "register" => "Register",
    ...
    //booking filter
    "cancelled" => "ຍົກເລີກແล້ວ",
    "confirmed_" => "ຢືນຢັນແล້ວ",
    "pending" => "ລໍຖ້າຢູ່",
    "on_the_way" => "ຢູ່ລະວ່າງການຂົນສົ່ງ",
    "delivered" => "ສົ່ງແล້ວ",
    "packet" => "ແພັກເກັດ",
    "done" => "ສຳເລັດ",
    "all" => "ທັງໝົດ",
    "today" => "ມື້ນີ້",
    "next_7_days" => "7 ມື້ຕໍ່ໄປ",
    "this_month" => "ເດືອນນີ້",
    "this_year" => "ປີນີ້",
    ...
    "sales" => "ການຂາຍ",
    "returns" => "ການຄືນ",
    "due_payments" => "ການຊໍາລະທີ່ຕ້ອງຈ່າຍ",
    "receiving" => "ການຊື້",
    "receives" => "ການຊື້",
    "receives_summary" => "ສະຫຼຸບການຊື້",
    "services" => "ການບໍລິການ",
    "booking" => "ການຈອງ",
    "reports" => "ລາຍງານ",
    "settings" => "ການຕັ້ງຄ່າ",
    "logout_nv" => "ອອກ​ຈາກ​ລະ​ບົບ",
    ...
    "pos_overview" => "POS ພາບລວມ",
    "last_12_months" => "12 ເດືອນຜ່ານມາ",
    "last_7_days" => "7 ມື້ຜ່ານມາ",
    "last_30_days" => "30 ມື້ຜ່ານມາ",
    ...
    "last_year" => "ປີຜ່ານມາ",
    "till_now" => "ຈົນເຖິງປະຈຸບັນ",
    "today_sales_invoice" => "ໃບບິນຂາຍວັນນີ້",
    "today_total_tax" => "ພາສີມື້ນີ້",
    "total_product" => "ສິນຄ້າທັງໝົດ",
    "today_profit" => "ກຳໄລມື້ນີ້",
    "last_thirty_days_profit" => "ກຳໄລ 30 ມື້ທີ່ຜ່ານມາ",
    "total_profit" => "ລວມກຳໄລທັງໝົດ",
    "sales_return" => "Sales Return",
    "sales_list" => "ລາຍການຂາຍ",
    "sales_list_small" => "ການຂາຍ",
    "sales_list_deleted_permanently" => "ການຂາຍຈະຖືກລຶບອອກຖາວອນ.",
    "shipment_list" => "ລາຍການຂົນສົ່ງ",
    "shipping" => "ການຂົນສົ່ງ",
    ...
    // Product
    "product" => "ສິນຄ້າ",
    "product_title" => "ຊື່ສິນຄ້າ",
    "product_details" => "ລາຍລະອຽດສິນຄ້າ",
    "products" => "ສິນຄ້າ",
    "description" => "ລາຍລະອຽດ",
    "product_category" => "ປະເພດສິນຄ້າ",
    "product_group" => "ກຸ່ມສິນຄ້າ",
    "categories" => "ປະເພດ",
    "all_products" => "ສິນຄ້າທັງໝົດ",
    "product_categories" => "ປະເພດສິນຄ້າ",
    "category" => "ປະເພດ",
    "edit_category" => "ເເກດປະເພດສິນຄ້າ",
    "add_category" => "ເພີ່ມປະເພດສິນຄ້າ",
    "category_name" => "ຊື່ປະເພດສິນຄ້າ",
    "brands" => "ແບນ",
    "product_brands" => "ແບນສິນຄ້າ",
    "product_brand" => "ແບນສິນຄ້າ",
    "add_brand" => "ເພີ່ມແບນ",
    "edit_brand" => "ແກ້ໄຂແບນ",
    "product_groups" => "ກຸ່ມສິນຄ້າ",
    "add_new_product" => "ເພີ່ມສິນຄ້າໃໝ່",
    "edit_product" => "ແກ້ໄຂສິນຄ້າ",
    "group" => "ກຸ່ມ",
    "brand" => "ແບນ",
    "standard_product" => "ສິນຄ້າມາດຕະຖານ",
    "variant_product" => "ຕົວເລືອກສິນຄ້າ",
    "variant" => "ຕົວເລືອກ",
    "value" => "ມູນຄ່າ",
    "product_attributes" => "ຄຸນລັກສະນະຕົວເລືອກສິນຄ້າ",
    "edit_attribute" => "ແກ້ໄຂຄຸນລັກສະນະຕົວເລືອກສິນຄ້າ",
    "edit_unit" => "ແກ້ໄຂຫົວໜ່ວຍ",
    "add_new_attribute" => "ເພີ່ມຄຸນລັກສະນະຕົວເລືອກສິນຄ້າໃໝ່",
    "add_new_unit" => "ເພີ່ມຫົວໜ່ວຍໃໝ່",
    "variant_attributes" => "ຄຸນລັກສະນະຕົວເລືອກ",
    "price" => "ລາຄາ",
    "purchase_price" => 'ລາ​ຄາ​​ຊື້',
    "selling_price" => "ລາຄາຂາຍ",
    "selling_price_label" => "ລາຄາຂາຍ",
    "receiving_price" => "ລາຄາຊື້",
    "purchase_price_label" => "ລາຄາຊື້",
    "product_deleted_permanently" => "ສິນຄ້າຈະຖືກລຶບອອກຖາວອນ.",
    "quantity" => "ປະລິມານ",
    "variants_title" => "ຊື່ຕົວເລືອກ",
    "tax_free_product" => "ສິນຄ້າປອດພາສີ",
    "tax_enabled_product" => "ສິນຄ້າພາສີ",
    "tax_included" => "ລວມພາສີ",
    "tax_excluded" => "ບໍ່ລວມພາສີ",
    "product_variants" => "ຕົວເລືອກສິນຄ້າ",
    "variants" => "ຕົວເລືອກ",
    "tax_free" => "ບໍ່ມີພາສີ",
    "tax_enabled" => "ເປີດໃຊ້ພາສີແລ້ວ",
    "upload_product_image" => "ອັບໂຫຼດຮູບສິນຄ້າ",
    "upload_variant_image" => "ອັບໂຫຼດຮູບຕົວເລືອກ",
    "variant_image" => "ຮູບພາບ",
    "browse" => "Browse",
    "availability" => "Availability",
    "sl" => "Sl",
    "add_variant_details" => "ເພີ່ມລາຍລະອຽດຕົວເລືອກ",
    "add_product_variants" => "ເພີ່ມຕົວເລືອກສິນຄ້າ",
    "update_product_image" => "ແກ້ໄຂຮູບສິນຄ້າ",
    "add_another_variant" => "ເພີ່ມຕົວເລືອກອື່ນໆ",
    "this_product_in_use" => "This product in use, You can not delete this product",
    "upload" => "ອັບໂຫຼດ",
    "select_existing_or_add_new" => "ເລືອກທີ່ມີຢູ່ແລ້ວຫຼືເພີ່ມໃຫມ່",
    ...
    // customers
    "customer" => "ລູກຄ້າ",
    "customer_avatar" => "ຮູບພາບລູກຄ້າ",
    "customers" => "ລູກຄ້າ",
    "add_customer" => "ເພີ່ລູກູຄ້າໃໝ່",
    "add_customer_label" => "ເພີ່ລູກູຄ້າໃໝ່",
    "customer_name" => "ຊື່ລູກຄ້າ",
    "customer_email" => "Email",
    "customer_mobile_number" => "ເບີໂທລະສັບລູກຄ້າ",
    "edit_customer" => "ແກ້ໄຂລູກຄ້າ",
    "customer_company" => "ບໍລິສັດ",
    "customer_code" => "Customer Code",
    "customer_website" => "Website",
    "customer_address" => "ທີ່ຢູ່",
    "customers_summary" => "ສະຫຼຸບລູກຄ້າ",
    "phone_number" => "ເບີໂທ",
    "phone_number_datatable" => "ເບີໂທ",
    "mobile_number" => "ເບີໂທລະສັບ",
    "users_type" => "ປະເພດຜູ້ໃຊ້",
    "client" => "ລູກຄ້າ",
    "customer_type" => "ປະເພດລູກຄ້າ",
    "customer_deleted_permanently" => "Customer will be deleted permanently.",
    "customer_details" => "ລະອຽດລູກຄ້າ",
    ...
    "discount" => "ສ່ວນຫຼຸດ",
    "default_discount" => "ຄ່າເລີ່ມຕົ້ນສ່ວນຫຼຸດ",
    "add_new_group" => "ເພີ່ມກຸ່ມໃໝ່",
    ...
    //Sales Register
    "cash_registers" => "ເງິນໂອນ",
    "cash_register_deleted_permanently" => "This cash register will be deleted permanently.",
    "add_cash_register" => "ເພີ່ມລາຍການເງິນໂອນ",
    "edit_cash_register" => "ແກ້ໄຂລາຍການເງິນໂອນ",
    "pay" => "ຈ່າຍ",
    "empty_cart" => "ບໍ່ມີສິນຄ້າ",
    ...
    "today_sell" => "ການຂາຍມື້ນີ້",
    "last_seven_days_sales" => "ການຂາຍ 7 ມື້ທີ່ຜ່ານມາ",
    "last_thirty_days_sales" => "ການຂາຍ 30 ມື້ທີ່ຜ່ານມາ",
    "total_sales" => "ລວມການຂາຍທັງໝົດ",
    "total_return" => "Total Return",
    "total_payment" => "Total Payment",
    "today_receiving" => "Today's Purchases",
    "last_thirty_days_receiving" => "Last 30 Days Receives",
    "bar_chart_title" => "ພາບລວມຍອກຂາຍແລະກຳໄລ",
    "sales_overview" => "Sales Overview",
    "chart_sub_title" => "ປີນີ້",
    "line_chart_sub_title" => "ອາທິດນີ້",
    "doughnut_chart_title" => "ກຳໄລ 7 ມື້ທີ່ຜ່ານມາ",
